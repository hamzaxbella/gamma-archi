...
export const HeroContent = {
    ...
    trust : [
        ...
        "Consultations et conseils gratuits.",
...
export const FAQcontent = [
    ...
    {Question : "Quels sont nos zones de travail géographiques  ?" , Answer : "Nous intervenons principalement dans la région du Nord du Maroc mais sommes ouverts à toutes destinations nationales et internationales."} ,
    {Question : "Quels sont nos messages clés ?" , Answer : "Nous visons l'excellence dans notre travail et notre relation avec les clients et le personnel. Notre engagement à être au top de notre stratégie est ce qui nous distingue et nous permet de gagner la confiance de nos clients."} ,
]
